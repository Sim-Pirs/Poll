...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form:form method="POST" modelAttribute="survey" action="${newSurvey}" cssClass="needs-validation">
                <div class="row">
                    <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="nbOptions"  value="2" name="nbOptions" required="required"/>
                </div>
