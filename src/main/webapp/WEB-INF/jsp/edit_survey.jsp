                            ...
                            <div class="card topShift">
                                <div class="card-body">
                                    ...
                                    <div class="input-group input-group-sm topShift">
                                        ...
                                        <form:input type="text" class="form-control" path="items[${cpt}].tags" multiple="multiple"/>
                                ...
                                <a class="btn btn-outline-danger btn-sm" href="<c:url value = "/sondage/items/supprimer?id=${survey.items.get(cpt).id}"/>">Supprimer (les modifications non sauvegardées seront perdu)</a>
                            </div>
                        </c:forEach>
                    </c:if>
                </div>
            </div>
            <a class="btn btn-outline-info btn-sm" href="<c:url value = "/sondage/items/ajouter?id=${survey.id}"/>">Ajouter un choix (les modifications non sauvegardées seront perdu)</a>
        </div>
